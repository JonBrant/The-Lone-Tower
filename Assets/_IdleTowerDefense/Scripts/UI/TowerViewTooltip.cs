...
public class TowerViewTooltip : MonoBehaviour
{
    ...
    private void OnMouseOver()
    {
        ...
        UITooltip.AddLineColumn($"<b>Health Regeneration</b>: {towerHealth.CurrentHealthRegeneration:N1}/s");
        UITooltip.AddLineColumn($"<b>Damage</b>: {towerWeapon.AttackDamage:N1}");
        UITooltip.AddLineColumn($"<b>Cooldown</b>: {towerWeapon.AttackCooldown:N2}s");
